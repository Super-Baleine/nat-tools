...
while [[ $choice != "1" || $choice != "2" || $choice != "3" ]]; do
	...
	2) delete the NAT router
	3) reconfigure IP" choice
done
...
case $choice in
		...
		"3")
			...
			echo "Finished !
			Router's IP : $routing
			Your public IP is : $public_ip with netmask $public_netmask
			Your private IP is : $private_ip with netmask $private_netmask";
			;;
esac
echo "
